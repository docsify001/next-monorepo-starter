...
CREATE TABLE "ads" (
	...
	"url" text NOT NULL,
	"image_url" text,
	"placement" varchar DEFAULT 'bottom',
...
CREATE INDEX "recommendation_apps_category_id_idx" ON "recommendation_apps" USING btree ("category_id");--> statement-breakpoint
CREATE INDEX "recommendation_apps_app_id_idx" ON "recommendation_apps" USING btree ("app_id");--> statement-breakpoint
CREATE UNIQUE INDEX "recommendation_apps_unique_idx" ON "recommendation_apps" USING btree ("category_id","app_id");--> statement-breakpoint
