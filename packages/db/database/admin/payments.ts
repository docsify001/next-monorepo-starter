...
export const paymentsDataAccess = {
  // 创建支付
  create: async (data: typeof zCreatePaymentSchema._type): Promise<typeof zCreatePaymentSchema._type> => {
  ...
  // 更新支付
  update: async (id: string, data: typeof zUpdatePaymentSchema._type): Promise<typeof zUpdatePaymentSchema._type> => {
